...
public class AuctionControllerTests
{
    ...
    {
        //arrange
        var auction = _fixture.Build<Auction>().Without(c => c.Item).Create();
    ...
    [Fact]
    public async Task DeleteAuction_WithValidUser_ReturnsOk()
    {
        //arrange
    ...
    [Fact]
    public async Task DeleteAuction_AuctionWithInvalidGuid_Returns404Response()
    {
        //arrange
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(value: null);
    ...
    [Fact]
    public async Task DeleteAuction_WithInvalidUser_Returns403Result()
    {
        //arrange
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "not-test";
